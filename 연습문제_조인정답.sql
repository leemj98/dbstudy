...
SELECT E.EMPLOYEE_ID, E.FIRST_NAME, E.HIRE_DATE AS 입사일자
  ...
  FROM EMPLOYEES E INNER JOIN EMPLOYEES M -- MANAGER_ID가 EMPLOYEE_ID를 참조하니 드라이브 테이블, 먼저 적기
    ON E.MANAGER_ID = M.EMPLOYEE_ID -- E 테이블의 MANAGER_ID가 M 테이블의 EMPLOYEE_ID를 참조 (E랑 M을 별개로 생각하면 쉬움. E 테이블 매니저를 M 테이블 사원번호로 조인한거랑 똑같음)
