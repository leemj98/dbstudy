...
ALTER TABLE SCHEDULE_TBL ADD CONSTRAINT FK_EVENT_SCHEDURE FOREIGN KEY(E_CODE) REFERENCES EVENT_TBL(E_CODE) ON DELETE SET NULL; -- ON DELETE CASCADE도 가능

-- 국가 테이블의 기본키 삭제하기
ALTER TABLE PLAYER_TBL   DROP CONSTRAINT FK_NATION_PLAYER; -- 국가 테이블의 기본키를 참조하는 외래키를 먼저 삭제
ALTER TABLE SCHEDULE_TBL DROP CONSTRAINT FK_NATION_SCHEDURE;
