...
CREATE TABLE MEMBER_T (
    ...
    MEM_POINT NUMBER,
    MEM_GUBUN VARCHAR2(7 BYTE)   CHECK(MEM_GUBUN IN('REGULAR','SOCIAL')),
...
ALTER TABLE MEMBER_T MODIFY MEM_GUBUN VARCHAR2(2O BYTE);
...
-- 9. 글내용 칼럼의 필수 제약조건을 제거하시오. (풀지말라고 함)
ALTER TABLE BOARD_T MODIFY CONTENT NULL;
